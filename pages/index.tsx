            ...
            >
              <Box>
                ...
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                  Инвестиции в интернете, в том числе с ежедневной выплатой –
                  это не просто раскрутка денег. Это способ сохранить средства,
                  предотвратить их обесценивание из-за инфляции, а также
                  приумножить их количество. Как известно сейчас в России, да и
                  во всем мире не лучшая экономическая обстановка. Цены растут,
                  а зарплаты остаются преимущественно на прежнем уровне. Поэтому
                ...
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                  ...
                  ежедневной оплатой, инвестиционные телеграм каналы, чаты и т.
                  д.
                </Text>
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                  Изучите наш ТОП сайтов и телеграм каналов, которые вы можете
                  использовать в инвестировании. У нас много проверенных
                  ресурсов, которые помогут вам разобраться с вложениями в
                  интернете с нуля.
                </Text>
                <Heading
                  as='h2'
                ...
                <OrderedList spacing={3} p={2}>
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    ...
                    просто. Этим могут заниматься люди даже с минимальным опытом
                    и квалификацией. Несложно найти проверенные и надежные
                    компании, которые создают лучшие условия для получения
                    пассивного дохода. К примеру, можно посмотреть безопасные
                    сайты для вложения денег под проценты.
                  </ListItem>
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                  ...
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    Для тех, кто занимается вложениями, есть много
                    вспомогательных инструментов и сервисов. К примеру, есть
                    телеграмм бот, и не один, при помощи которого можно получать
                    аналитику и следить за движением котировок.
                  </ListItem>
                </OrderedList>
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                ...
                <List spacing={3} p={2}>
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    ...
                    сайте инвестиционной тематики и т. д. То есть понять, в
                    какие вкладывать акции или облигации, где лучше делать
                    инвестиции, какие активы вы хотите иметь и с какой
                    перспективой. Хотите ли сделать самые высокодоходные
                    инвестиции используя популярные сайты? Или вам интересны
                    вклады в другие выгодные ресурсы с ежедневной выплатой, к
                    примеру, в telegram, где реальные деньги, пусть и небольшие,
                    регулярно поступают на ваш счет.
                  </ListItem>
                  ...
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    ...
                    проверенный ТОП проект начнет «проседать», не спешите
                    сливать активы. Оценивайте перспективу, взвешивайте «за» и
                    «против», не впадайте в панику, азарт, эйфорию.
                  </ListItem>
                </List>
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                ...
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                  ...
                  сотрудничества по таким инвестициям необходимо обсудить в
                  личной переписке с администратором проекта.
                </Text>
                <Heading
                  as='h5'
                  pl={'2'}
                ...
                <Text as='p' fontSize={{ base: 'md', md: 'lg' }} p={2}>
                  Чтобы ваши деньги успешно работали, нужно не просто найти
                  лучшие сайты для инвестиций, но и избегать распространенных
                  ошибок, которые допускают новички:
                </Text>
                <List spacing={3} p={2}>
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    <ListIcon as={CheckIcon} color='green.500' />
                  ...
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    <ListIcon as={CheckIcon} color='green.500' />
                    Отсутствие диверсификации. Проще говоря, самое
                    недальновидное, что можно сделать в сфере инвестирования –
                    вложить все деньги в один проект, к примеру, в раскрутку
                    счета в телеграмме. Без риска, конечно все равно не
                    обойтись, но чем шире рассредоточены ваши средства, тем
                    меньше вероятность того, что вы потеряете абсолютно все.
                  </ListItem>
                  <ListItem fontSize={{ base: 'md', md: 'lg' }}>
                    <ListIcon as={CheckIcon} color='green.500' />
